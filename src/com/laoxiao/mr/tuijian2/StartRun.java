...
public class StartRun {
	...
	public static void main(String[] args) {
		...
		paths.put("Step6Input", paths.get("Step1Output"));
		paths.put("Step6Output", "/usr/output/step6");
		paths.put("Step7Input1", paths.get("Step5Output"));
		paths.put("Step7Input2", paths.get("Step6Output"));
		paths.put("Step7Output", "/usr/output/step7");
		paths.put("Step8Input", paths.get("Step7Output"));
		paths.put("Step8Output", "/usr/output/step8");
...
//		Step6.run(config, paths);
		Step7.run(config, paths);
		Step8.run(config, paths);
	}
