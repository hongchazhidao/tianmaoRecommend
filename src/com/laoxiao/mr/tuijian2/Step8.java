...
public class Step8 {
	...
	public static boolean run(Configuration config, Map<String, String> paths) {
		try {
			...
			FileInputFormat
					.addInputPath(job, new Path(paths.get("Step8Input")));
	...
	static class Step8_Mapper extends Mapper<LongWritable, Text, PairWritable, Text> {
	...
	static class Step8_Reducer extends Reducer<PairWritable, Text, Text, Text> {
